...
# ПРАВИЛЬНИЙ CORS: додаємо методи DELETE та OPTIONS явно
...
def login():
    ...
    if user and user.password_hash == password:
        return jsonify({"message": "Вхід успішний!", "user_id": user.id, "username": user.username}), 200
